...
The following sections will survive any termination of these Terms or of your Account: \ref{sec:things-you-cannot-do} (\nameref{sec:things-you-cannot-do}), \ref{sec:indemnity} (\nameref{sec:indemnity}), \ref{sec:disclaimers} (\nameref{sec:disclaimers}), \ref{sec:limitation-of-liability} (\nameref{sec:limitation-of-liability}), \ref{sec:governing-law} (\nameref{sec:governing-law}), \ref{sec:termination} (\nameref{sec:termination}), and \ref{sec:miscellaneous} (\nameref{sec:miscellaneous}).
